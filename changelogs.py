...
""",'2.5.0.0': """*Версия 2.5.0.0:* _2026-04-04_
🍑 У тех, кто участвовал в первоапрельских забавах, в профиле теперь отображается имя/статус попы. Команды для них по-прежнему работают, но новых поп не будет (возможно, в 2027 повторим 😈).
📢 У бота наконец появился [свой канал](https://t.me/BotenDana), правда, постить в него он сам пока ещё не может по техническим причинам (ленивые разрабы). Там пока почти ничего нету, но планируется кидать полезную информацию и обновления. Ссылка по идее должна быть где-то в профиле у бота, если эта не работает.""",
    '2.6.0.0': """*Версия 2.6.0.0:* _2026-06-27_
👋 Теперь бот по-разному "провожает" в отличии от того, ушёл ли юзер сам, или ему "помогли" 😉
👨🏻‍🦱 По многочисленным просьбам трудящихся, наконец добавлена возможность настроить, как часто бот отвечает картинками с Киркоровым. Достаточно написать "настройки Киркорова", и дальше офигительно удобный интерфейс всё сделает.
📢 Это последнее обновление, про которое бот спамит во все чаты, в которых сидит. Дальнейшие обновления бот будет кидать в [свой канал](https://t.me/BotenDana), а также в любой чат, подписавшийся на обновления (пока этого никак не сделать, увы, как будет - обязательно всё будет описано в обновлении).""",
    "2.6.1.0": """*Версия 2.6.1.0:* _2026-07-08_
📄 По многим функциям написана справка - команда /help в помощь. Описано далеко не всё, но дорабаывается со временем.    
📢 Теперь на обновления бота можно подписаться - команда /news\\_subscribe показывает статус подписки, а у администраторов чата выдаёт кнопки для включения и выключения. 
    """}
